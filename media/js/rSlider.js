// from https://slawomir-zaziablo.github.io/range-slider/ 
// Conseilgouz : allow steps with decimal
(function () {
	'use strict';
	...
	RS.prototype.createSlider = function () {
		...
		this.sliderWidth = this.slider.clientWidth -1; // ajustement
	...
	RS.prototype.createScale = function (resize) {
		this.step = parseInt(this.sliderWidth / (this.conf.values.length - 1));
	...
	RS.prototype.onResize = function () {
		this.sliderLeft = this.slider.getBoundingClientRect().left;
		this.sliderWidth = this.slider.clientWidth -1;
	...
	prepareArrayValues = function (conf) {
		...
		for (var i = 0, iLen = (range / conf.step); i < iLen; i++) {
            let aval = parseInt(conf.values.min) + i * conf.step;
			values.push(aval.toString());
        }
